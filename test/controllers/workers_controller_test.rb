...
class WorkersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create worker" do
    assert_difference("Worker.count") do
      post workers_url, params: { worker: { department: @worker.department, name: @worker.name, year: @worker.year } }
    end
  ...
  test "should update worker" do
    patch worker_url(@worker), params: { worker: { department: @worker.department, name: @worker.name, year: @worker.year } }
